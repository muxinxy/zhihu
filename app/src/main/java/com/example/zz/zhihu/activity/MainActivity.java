...
import com.example.zz.zhihu.adapter.ColumnAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyDatabaseHelper dbHelper = new MyDatabaseHelper(this, "data.db", null, 1);
        ...
        com.example.zz.zhihu.adapter.ColumnAdapter columnAdapter = new ColumnAdapter(columnList);
